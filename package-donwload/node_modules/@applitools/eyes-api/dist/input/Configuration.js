...
class ConfigurationData {
    ...
    setShowLogs(show) {
        var _a;
        if (show)
            (_a = this.logs) !== null && _a !== void 0 ? _a : (this.logs = { type: 'console' });
        else
            this.logs = null;
        return this;
    }
    ...
    get apiKey() {
        var _a;
        return (_a = this._config.apiKey) !== null && _a !== void 0 ? _a : utils.general.getEnvValue('API_KEY');
    }
    set apiKey(apiKey) {
    ...
    get serverUrl() {
        var _a;
        return (_a = this._config.serverUrl) !== null && _a !== void 0 ? _a : utils.general.getEnvValue('SERVER_URL');
    }
    ...
    get branchName() {
        var _a;
        return (_a = this._config.branchName) !== null && _a !== void 0 ? _a : utils.general.getEnvValue('BRANCH');
    }
    ...
    get parentBranchName() {
        var _a;
        return (_a = this._config.parentBranchName) !== null && _a !== void 0 ? _a : utils.general.getEnvValue('PARENT_BRANCH');
    }
    ...
    get baselineBranchName() {
        var _a;
        return (_a = this._config.baselineBranchName) !== null && _a !== void 0 ? _a : utils.general.getEnvValue('BASELINE_BRANCH_NAME');
    }
    ...
    get dontCloseBatches() {
        var _a;
        return (_a = this._config.dontCloseBatches) !== null && _a !== void 0 ? _a : utils.general.getEnvValue('DONT_CLOSE_BATCHES', 'boolean');
    }
    /** @undocumented */
