...
function transformDriver(driver) {
    ...
    const modifiedDriver = webdriver_1.default.attachToSession(options, undefined, additionalCommands);
    if (environment.isAndroid) {
        modifiedDriver === null || modifiedDriver === void 0 ? void 0 : modifiedDriver.updateSettings({ allowInvisibleElements: true });
    }
